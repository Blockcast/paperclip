...
describe("claude execute", () => {
  ...
  it("classifies Claude 'out of extra usage' failures as provider_quota_exhausted", async () => {
    ...
    try {
      const result = await execute({
        ...
        runtime: {
          ...
          sessionDisplayId: "aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaaaa",
          taskKey: null,
        },
        config: {
          command: commandPath,
    ...
    try {
      const result = await execute({
        ...
        runtime: {
          ...
          sessionDisplayId: "aaaaaaaa-0000-4000-8000-000000000004",
          taskKey: null,
        },
        config: {
          command: commandPath,
