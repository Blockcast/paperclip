...
describe("codex local adapter metadata", () => {
  it("advertises current GPT-5.6 models while retaining the subscription-safe default", () => {
    ...
    expect(isCodexLocalFastModeSupported(DEFAULT_CODEX_LOCAL_MODEL)).toBe(false);
