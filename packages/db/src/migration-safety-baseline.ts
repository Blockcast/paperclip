...
export const MIGRATION_SAFETY_BASELINE = [
  ...
  },
  {
    id: "512681481d05df70",
    rule: "large-create-index-not-concurrently",
    migration: "0098_activity_log_entity_id_idx.sql",
    table: "activity_log",
    reason: "Downstream production index migration predates the migration-safety guard.",
  },
  {
    id: "7cd800860146f945",
    rule: "large-create-index-not-concurrently",
    migration: "0103_activity_log_issue_lookup_indexes.sql",
    table: "activity_log",
    reason: "Existing transactional migration reconciles an index created concurrently out of band in production.",
  },
  {
    id: "6f342294ffa05e70",
    rule: "large-create-index-not-concurrently",
  ...
  },
  {
    id: "581ee8dc29d7aee0",
    rule: "large-create-index-not-concurrently",
    migration: "0154_issue_comment_derived_attribution_fast.sql",
    table: "issue_comments",
